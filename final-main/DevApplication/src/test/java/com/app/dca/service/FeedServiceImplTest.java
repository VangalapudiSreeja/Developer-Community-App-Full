...
public class FeedServiceImplTest {
	...
	void testSaveFeed() {
		Feed input = new Feed(10,"what is JDBC",LocalDate.of(2021,03,25), LocalTime.of(4, 23, 12),"JDBC",10,d,1,"JDBC basics");
		Feed savedFeed = new Feed(10,"what is JDBC",LocalDate.of(2021,03,25), LocalTime.of(4, 23, 12),"JDBC",10,d,1,"JDBC basics");
